...
**P2S Printers**: P2S printers require USB storage (SD card or USB drive) to be connected for file uploads to succeed. If your P2S doesn't have USB storage connected, file transfers will fail.
